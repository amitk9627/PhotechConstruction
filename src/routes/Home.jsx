            ...
            <div className=''>
                ...
                <div>
                    <div className='my-10 mx-32  flex justify-between max-lg:flex-col gap-10 max-lg:mx-12 max-md:mx-3  '>
                        <div className='relative max-lg:flex max-lg:gap-3 max-lg:py-6 max-lg:flex-col max-lg:items-center max-lg:justify-center border-8 border-yellow-400 p-4 w-1/2 max-lg:w-full rounded-br-3xl rounded-tl-3xl max-lg:p-0'>
                            ...
                            <div className='max-lg:relative max-lg:w-96 absolute lg:bottom-20 lg:-left-36 w-72 
                            ...
                            <div className='max-lg:relative max-lg:w-96 max-md:bottom-0 
                        ...
                        <div className='w-1/2 max-lg:w-full'>
                            <div className='text-xl text-gray-800 max-lg:px-2'>
                                ...
                                <div className='flex flex-col gap-2 mt-4'>
                                    <p className='flex items-center gap-6'><IoIosConstruct className='text-2xl text-yellow-400' /><span>fabrication & erection of reformers</span></p>
                                    <p className='flex items-center gap-6'><IoIosConstruct className='text-2xl text-yellow-400' /><span>heaters</span></p>
                                    <p className='flex items-center gap-6'><IoIosConstruct className='text-2xl text-yellow-400' /><span>vessels</span></p>
                                    <p className='flex items-center gap-6'><IoIosConstruct className='text-2xl text-yellow-400' /><span>tanks</span></p>
                                    <p className='flex items-center gap-6'><IoIosConstruct className='text-2xl text-yellow-400' /><span>erection of heavy static & rotary equipment</span></p>
                                    <p className='flex items-center gap-6'><IoIosConstruct className='text-2xl text-yellow-400' /><span>piping & structures</span></p>
                                </div>
                            </div>
                        </div>
